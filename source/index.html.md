...
### HTTP Request
<br/>
<span class='api-url'><span class='get'>GET</span> /customer_search?api_key={your_api_key}&api_secret={your_api_secret}&zbs_query={YOUR_SEARCH_QUERY}</span>
...
### HTTP Request
<br/>
<span class='api-url'><span class='get'>GET</span> /quotes?api_key={your_api_key}&api_secret={your_api_secret}</span>
...
### HTTP Request
<br/>
<span class='api-url'><span class='get'>GET</span> /invoices?api_key={your_api_key}&api_secret={your_api_secret}</span>
...
### HTTP Request
<br/>
<span class='api-url'><span class='post'>POST</span> /create_transaction?api_key={your_api_key}&api_secret={your_api_secret}</span>
...
### HTTP Request
<br/>
<span class='api-url'><span class='get'>GET</span> /transactions?api_key={your_api_key}&api_secret={your_api_secret}</span>
...
### HTTP Request
<br/>
<span class='api-url'><span class='post'>POST</span> /create_event?api_key={your_api_key}&api_secret={your_api_secret}</span>
...
### HTTP Request
<br/>
<span class='api-url'><span class='get'>GET</span> /events?api_key={your_api_key}&api_secret={your_api_secret}</span>
